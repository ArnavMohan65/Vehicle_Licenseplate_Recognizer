...
def load_model(path, train = False):
    # print(self.device)
    model = attempt_load_org(path, map_location=device)  # load FP32 model
...
# char_model = torch.hub.load('ultralytics/yolov5', 'yolov5n')
char_model = load_model("yolov5_face/char.pt")
