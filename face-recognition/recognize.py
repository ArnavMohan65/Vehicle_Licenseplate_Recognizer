...
from models.experimental import attempt_load_face as attempt_load
...
## Case 2:
model = attempt_load("face-recognition/yolov5_face/yolov5n-0.5.pt", map_location=device)
...
def get_face(input_image):
    ...
    # print(img.shape[1:], det[:, 5:15], input_image.shape)
    print(det.shape)
...
def main():
    ...
    video = cv2.VideoWriter('face-recognition/static/results/face-recognition2.mp4',cv2.VideoWriter_fourcc(*'mp4v'), 6, size)
